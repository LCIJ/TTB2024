...
Testorbit1.coordtype = 'Equatorial'
Testorbit1.usebaumgardtcoord = True
Testorbit1.orbprop   = True
# Testorbit1.paramtime = [0, -5000, 0.1]
Testorbit1.paramtime = [0, -5000, 0.1] # t_init, t_fin, dt
ra,dec,dist,vlos,pmac,pmd       = 219.901, -26.539, 34.84, -139.55, -0.464, -1.105
Testorbit1.paramvars      = [[ra,dec,dist,vlos,pmac,pmd]]
ra,dec,dist,vlos,pmac,pmd      = 225.994, -33.068, 31.71, -25.24, -1.189, -2.234
Testorbit1.paramvars.append([ra,dec,dist,vlos,pmac,pmd])
ra,dec,dist,vlos,pmac,pmd       = 251.745, 47.528, 30.11, -138.64, -1.171, -0.467
Testorbit1.paramvars.append([ra,dec,dist,vlos,pmac,pmd])
ra,dec,dist,vlos,pmac,pmd       = 315.372, 16.187, 39.32, -383.47, -0.128, -0.633
Testorbit1.paramvars.append([ra,dec,dist,vlos,pmac,pmd])
ra,dec,dist,vlos,pmac,pmd       = 347.111, -15.611, 24.39, -176.70, 0.756, -2.320
Testorbit1.paramvars.append([ra,dec,dist,vlos,pmac,pmd])
ra,dec,dist,vlos,pmac,pmd       = 346.685, 12.772, 23.48, 25.87, 1.748, 0.104
Testorbit1.paramvars.append([ra,dec,dist,vlos,pmac,pmd])
ra,dec,dist,vlos,pmac,pmd       = 30.737, -3.253, 30.59, -130.41, -0.228, -2.046
Testorbit1.paramvars.append([ra,dec,dist,vlos,pmac,pmd])
